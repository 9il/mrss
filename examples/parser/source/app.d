 ...
 */
/**
  Example application for mrss RSS feed parser
  Authors: Laeeth Isharc and Ilya Yaroshenko
*/
module kaleidic.api.mrss.example;
...
string toString(mrss_version_t mrssVersion)
{
  final switch(mrssVersion) with(mrss_version_t)
  {
